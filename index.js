const autoCompleteConfig = {
    ...
    fetchData: async (searchTerm) => {
        // axios allows us to pass params neatly as an object rather than attaching all params using '?' on the URL itself!
...
const movieTemplate = (movieDetail => {
    ...
    <article class="media">
      <figure class="media-left">
        <p class="image">
            <img src="${movieDetail.Poster}" alt="${movieDetail.Title} (${movieDetail.Year})" />
        </p>
      </figure>
